...
from dataset import FLAG3DTrainDatasetGenerator, FLAG3DTestDatasetGenerator
...
if __name__ == "__main__":
    ...
    logger = get_logger(logs_path + "/2sagcn_flag3d_train_exp.txt")
