...
from dataset import FLAG2DTestDatasetGenerator
...
logger = get_logger(logs_path + "/2sagcn_flag2d_test_exp.txt")

dataset_val_generator = FLAG2DTestDatasetGenerator("../data/FLAG/flag2d.pkl", 500)
...
param_dict = mindspore.load_checkpoint("./chpk_resume/2sagcn_2d.ckpt")
