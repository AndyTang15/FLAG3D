...
class FLAG2DPoseC3DTrainDatasetGenerator:
    ...
    def __getitem__(self, index):
        return ToTensor_train.transform(self.dataset[index])['imgs'], ToTensor_train.transform(self.dataset[index])['label']
...
class FLAG2DPoseC3DTestDatasetGenerator:
    ...
    def __getitem__(self, index):
        return ToTensor_val_test.transform(self.dataset[index])['imgs'], ToTensor_val_test.transform(self.dataset[index])['label']
