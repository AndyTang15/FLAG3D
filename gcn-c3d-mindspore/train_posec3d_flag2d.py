...
from dataset import FLAG2DPoseC3DTrainDatasetGenerator, FLAG2DPoseC3DTestDatasetGenerator
...
def main(args: argparse, logger):
    ...
    if args.mode == 'test':
        test_acc_top1, test_acc_top5 = test(dataset_test, model, celoss, logger, args)
        return
    ...
    if args.mode == 'train':
        ...
        for i in range(args.epochs):
            ...
            val_acc_top1, _ = test(dataset_test, model, celoss, logger, args)
